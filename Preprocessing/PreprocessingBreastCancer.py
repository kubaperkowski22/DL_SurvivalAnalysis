...
def prepare_breast_cancer_data(filepath):
    ...
    # Odrzucenie pacjentek bez ustalonego czasu przeżycia
    ...
    for col in num_cols:
        if col in df.columns:
            ...
            # W kolumnach dotyczących węzłów chłonnych wartości >= 98 często oznaczają braki
    ...
    # Rzutowanie na string, aby uwzględnić numeryczne kody zabiegów jako kategorie
