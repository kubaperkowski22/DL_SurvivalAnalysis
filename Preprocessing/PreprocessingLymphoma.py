...
def prepare_lymphoma_data(filepath):
    ...
    num_cols = [
        ...
        "Sentinel Lymph Nodes Examined (2018+)",
        "Sentinel Lymph Nodes Positive (2018+)",
    ...
    for col in num_cols:
        if col in df.columns:
            ...
            # Wyzerowanie specyficznych kodów braków danych dla węzłów (98 i 99)
            if 'nodes' in col.lower() or 'node' in col.lower():
