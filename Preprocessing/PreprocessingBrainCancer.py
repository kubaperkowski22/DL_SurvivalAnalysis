...
def prepare_brain_cancer_data(filepath):
    ...
    # Odrzucanie pacjentow bez informacji o czasie przeżycia
    ...
    # C. Zmienne kategoryczne (One-Hot Encoding)
    cat_cols = [
        "Sex",
    ...
    # traktowanie kodów liczbowych jako tekst, aby get_dummies poprawnie je zakodowało
    ...
    try:
        ...
        df_train, df_val = train_test_split(df_train, test_size=0.25, random_state=42) # 60% Train, 20% Val, 20% Test
    except ValueError:
